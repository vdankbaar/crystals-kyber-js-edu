...
(function (factory) {
    ...
    (0, bdd_js_1.describe)("Kyber768", () => {
        ...
        (0, bdd_js_1.beforeAll)(async () => {
            ...
            ct = new Array(100);
            ss = new Array(100);
            const data = await dntShim.Deno.readTextFile((0, utils_js_2.testVectorPath)() + "/PQCkemKAT_2400.rsp");
        ...
        (0, bdd_js_1.describe)("PQCkemKAT_2400.rsp", () => {
            (0, bdd_js_1.it)("should match values in test vectors", async () => {
                const kyber = new mod_js_1.Kyber768();
                for (let i = 0; i < 100; i++) {
        ...
        (0, bdd_js_1.describe)("A sample code in README.", () => {
            (0, bdd_js_1.it)("should work normally", async () => {
                const recipient = new mod_js_1.Kyber768();
                const [pkR, skR] = await recipient.generateKeyPair();
                const sender = new mod_js_1.Kyber768();
